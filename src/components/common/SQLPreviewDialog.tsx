...
export function SQLPreviewDialog({ sql, onClose, onExecute }: SQLPreviewDialogProps) {
  ...
  return (
    <Modal
      ...
      panelClassName="flex max-h-[80vh] w-full max-w-2xl flex-col rounded-lg border border-[var(--color-border)] bg-[var(--color-bg-primary)] shadow-2xl"
    >
      ...
      <div className="flex items-center justify-end gap-2 border-t border-[var(--color-border)] px-4 py-3">
        ...
        <button
          ...
          className="flex items-center gap-1.5 rounded bg-brand-600 px-3 py-1.5 text-xs font-medium text-white hover:bg-brand-700"
        >
