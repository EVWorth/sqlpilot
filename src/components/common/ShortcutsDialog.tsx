...
const sections: { title: string; shortcuts: ShortcutEntry[] }[] = [
  {
    ...
    shortcuts: [
      ...
      { keys: "Ctrl+Shift+L", description: "Lowercase selected keywords" },
      { keys: "Ctrl+Shift+U", description: "Uppercase selected keywords" },
      { keys: "Ctrl+/", description: "Toggle line comment" },
      { keys: "Ctrl+Shift+/", description: "Toggle block comment" },
      { keys: "Ctrl+D", description: "Duplicate line / selection" },
      { keys: "Alt+Up / Alt+Down", description: "Move line up / down" },
  ...
  },
  {
    title: "Navigation",
    shortcuts: [
      { keys: "Ctrl+N / Ctrl+T", description: "New query tab" },
